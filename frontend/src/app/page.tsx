    ...
    <div className="pb-32 relative">
      ...
      <footer className="mt-32 relative z-20">
        <div className="max-w-[1200px] mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-center gap-8 relative">
          ...
          <div className="flex items-center justify-center gap-10 md:w-1/3">
            ...
            <a href="https://linkedin.com/in/anish2804" target="_blank" rel="noopener noreferrer" className="text-[#666] hover:text-[#0a66c2] transition-colors">
              <svg viewBox="0 0 24 24" width="28" height="28" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
            </a>
            <a href="https://twitter.com/anish2804" target="_blank" rel="noopener noreferrer" className="text-[#666] hover:text-[#1d9bf0] transition-colors">
          ...
          <div className="flex flex-col gap-2 text-center md:text-right md:w-1/3">
            <span className="text-[14px] font-medium text-[#777]">Built by Anish</span>
          </div>
        </div>
      </footer>
    </div>
